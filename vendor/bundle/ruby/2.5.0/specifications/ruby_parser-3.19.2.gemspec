# -*- encoding: utf-8 -*-
# stub: ruby_parser 3.19.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.required_ruby_version = Gem::Requirement.new(["< 4".freeze, ">= 2.1".freeze])
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<rake>.freeze, ["< 15", ">= 10"])
      ...
      s.add_dependency(%q<rake>.freeze, ["< 15", ">= 10"])
